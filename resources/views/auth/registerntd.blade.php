...
<div class="container">
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
     <div class="up3" style="height:400px;height:auto;padding: 0px">
                                          ...
                                          <form method="POST" action="{{ route('register') }}">
                                            @csrf
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="name" style="margin: 0px" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                                            ...
                                            <input type="hidden" id="id_permission" name="id_permission" value="{!!$id_permission!!}">
...
<center style="padding: 20px"><p>Bạn đã có tài khoản ? <a href="{{ route('login') }}"><u>Đăng nhập ngay</u></a></p></center>
</div>
</body>

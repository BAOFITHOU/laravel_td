      ...
      <div class="row">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('xemthongtinntd',$ntds->id) }}">Nhà Tuyển Dụng</a></li>
            @endforeach
          </ol>
        </nav>
        <p></p>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
       ...
       <div class="row" style="padding: 30px">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
          <img src="images/{{ $tintds->thongtinntd->users->avatar }}" style="width:80px;height:80px;border-radius: 50%" alt="">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
          <div class="chitietcongviec">
            <a href="{{ route('gettintuyendung',$tintds->id) }}"> <h5 class="text-left">{{ $tintds->tieudetin }}</h5> </a>
            <p>
              <a class="text-left" href="{{ route('xemthongtinntd',$tintds->id_ntd) }}"><span>{{ $tintds->thongtinntd->tencongty }}</span></a>
            </p>

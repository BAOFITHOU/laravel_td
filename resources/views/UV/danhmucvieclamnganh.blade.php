      ...
      <div class="row">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('xemdanhmucvieclamnganh',$tennganhs->id) }}">{{ $tennganhs->tennganh }}</a></li>
            @endforeach
          </ol> 
        </nav>
        <p></p>
        ...
        <div class="up3" style="height:490px;height:auto;padding: 0px">
          ...
          <div class="row" style="padding: 30px">
            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
              <img src="images/{{$danhmucs->thongtinntd->users->avatar}}"style="width:80px;height:80px;border-radius: 50%" alt="">
            </div>

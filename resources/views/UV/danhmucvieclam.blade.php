    ...
    <div class="col-md-12 text-center">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/2">Công nghệ sinh học</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/4">Công nghệ kỹ thuật điện tử - viễn thông</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            ...
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/5">Luật</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/6">Kiến trúc</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/8">Luật kinh tế</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            ...
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/11">Ngôn ngữ Tiếng Trung</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/13">Ngôn ngữ Tiếng Trung</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/15">Công nghệ thực phẩm</a></h4>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
          <div class="nddanhmucx">
            <div class="noidungicondanhmuc" style="margin: 10px">
              <h4><a href="Ungvien/danhmucvieclamnganh/16">Luật quốc tế</a></h4>

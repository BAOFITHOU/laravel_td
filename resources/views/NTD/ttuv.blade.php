      ...
      <div class="row">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('xemuvphuhop',$thongtins->id) }}">Thông tin ứng viên</a></li>
            @endforeach
          </ol>
        </nav>
        <p></p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" >
            <center>
              <div class="avata" style="padding-top: 40px">
                ...
                <small style="color:blue;">*Thông tin liên hệ</small>
        ...
        <div class="up3" style="min-height:300px;border-radius: 20px;margin-top: 10px;padding: 20px"> 
          <center>
            <p><a href="cv/{{$cv->tenfilecv}}"><i class="fas fa-eye" style="font-size: 20px;"></i></a>
              <a href="{{route('down',$cv->tenfilecv)}}"><i class="fas fa-download" style="font-size: 20px"></i></a></p>
              <h4><b><span>CV Ngành : {{$cv->nganh->tennganh}}</span></b></h4>
              <p><b>Vị trị mong muốn :</b> {{ $cv->vitrimongmuon }}</p>
